...
in research, learning and collaborating. The /Page Rank/ method, which
originally underpinned /Google/'s search-engine, essentially asserts that the
...
#+begin_src R :session graph-two :results output graphics file :file pure-math-adj-graph.png :exports results
library(igraph)
library(tidyverse)

g1 <- igraph::graph.formula(30-15, 30-5, 30-6, 30-3, 30-2, 29,
                            28-7, 28-4, 28-2, 27, 26-13, 26-2,
                            25-5, 24-8, 24-4, 24-2, 24-6, 24-3,
                            23, 22-11, 22-2, 21-3, 21-7, 20-5,
                            19, 18-2, 18-3, 18-9, 17, 16-4, 16-2,
                            16-8, 15-3, 15-5, 14-7, 14-2, 13,
                            12-4, 12-3, 12-2, 11, 10-5, 10-2,
                            9-3, 8-2, 8-4, 7, 6-3, 6-2,
                            5, 4-2, 3, 2)
plot(g1)
...
eigen(S)$vectors[eigen(S)$values == max(abs(eigen(S)$values))]

##  [1] -5.843491e-01+0.000000e+00i -6.601213e-01+0.000000e+00i
##  [3]  3.202267e-01+0.000000e+00i  2.492578e-01+0.000000e+00i
##  [5] -1.962477e-01+0.000000e+00i -4.329437e-02+0.000000e+00i
##  [7] -6.322935e-16+0.000000e+00i -1.007660e-15+0.000000e+00i
##  [9]  1.022704e-01+0.000000e+00i -1.994323e-01+0.000000e+00i
## [11] -1.065640e-01+0.000000e+00i  4.603345e-01+0.000000e+00i
## [13] -2.612568e-01+0.000000e+00i -1.221066e-01+0.000000e+00i
## [15]  1.343894e-01+0.000000e+00i -2.620028e-01+0.000000e+00i
## [17] -7.592911e-01+0.000000e+00i  7.331970e-01+0.000000e+00i
## [19] -2.065287e-01+0.000000e+00i  2.075317e-02+0.000000e+00i
## [21] -3.047677e-01+0.000000e+00i  2.937879e-01+0.000000e+00i
## [23]  7.520500e-03+0.000000e+00i  1.169962e-17+1.517458e-16i
## [25]  1.169962e-17-1.517458e-16i  7.182818e-17+0.000000e+00i
## [27]  4.229494e-18+0.000000e+00i -7.094677e-17+0.000000e+00i
## [29]  2.147605e-17+0.000000e+00i
#+end_src

#+NAME: pure-math-graph
#+CAPTION: Graph of \mathbb{Z}^+ \leq 30$ with edges based on divisors
#+RESULTS[584f27a74243425dd10da1ffa292cf7a4cd21e4a]: pure-math-adj
